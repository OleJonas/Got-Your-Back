...
from Queue_multiprocessing import Pred_Queue, Data_Queue
...
def data_collection(pred_queue):
...
if __name__ == "__main__":
    ...
    # Processes
    data_collection_process = multiprocessing.Process(target=data_collection, args=[pred_queue], daemon=True)
    classification_process = multiprocessing.Process(target=classification, args=[pred_queue], daemon=True)
